...
def launch_claude_stream_json(
    ...
    try:
        log("Lancement de Claude (stream-json)...\n")
        ...
        # Lire stdout ligne par ligne (chaque ligne est un JSON)
        while True:
            # Vérifier timeout
...
def launch_claude_process(
    ...
    result = launch_claude_stream_json(
        prompt=prompt,
        request=request,
        max_timeout=1800,
        verbosity=verbosity
